          ...
          <div className="py-1">
            <button
              ...
              className={`block w-full text-left px-4 py-2 text-sm ${
                currentSort === 'price-asc' ? 'bg-amber-100 text-amber-800' : 'text-gray-700 hover:bg-gray-100'
              }`}
            >
              Price: Low to High
            </button>
            <button
              ...
              className={`block w-full text-left px-4 py-2 text-sm ${
                currentSort === 'price-desc' ? 'bg-amber-100 text-amber-800' : 'text-gray-700 hover:bg-gray-100'
              }`}
            >
              Price: High to Low
            </button>
            <button
              ...
              className={`block w-full text-left px-4 py-2 text-sm ${
                currentSort === 'newest' ? 'bg-amber-100 text-amber-800' : 'text-gray-700 hover:bg-gray-100'
              }`}
            >
              Newest First
            </button>
