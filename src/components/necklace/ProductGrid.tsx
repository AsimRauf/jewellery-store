...
interface ProductGridProps {
  ...
  onLoadMore: () => void;
  onProductClick: (product: Necklace) => void;
  onAddToCart: (product: Necklace) => void;
}
...
const ProductGrid: React.FC<ProductGridProps> = ({ 
  ...
  const getImageUrl = (product: Necklace): string => {
    ...
    return '/placeholder-necklace.jpg'; // Make sure this file exists in your public directory
  };
  ...
  if (!loading && products.length === 0) {
    return (
      <div className="text-center py-12">
        <h3 className="text-xl font-medium mb-4">No necklaces found</h3>
        <p className="text-gray-600 mb-6">
          We couldn&apos;t find any necklaces matching your criteria. Try adjusting your filters.
        </p>
        <button
          onClick={clearAllFilters}
          className="px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600"
    ...
    <div>
      ...
      {loadingMore && (
        <div className="text-center py-6">
          ...
          <p className="mt-2 text-gray-600">Loading more necklaces...</p>
        </div>
      )}
