...
const ReviewsPage = () => {
  const allReviews = [
    ...
    },
    {
      ...
      location: "Denver, CO",
      rating: 5,
      review: "The pendant I ordered was even more beautiful in person. The craftsmanship is outstanding and it arrived perfectly packaged. I receive compliments every time I wear it. Definitely shopping here again!",
      product: "Gold Heart Pendant",
      date: "3 days ago",
      verified: true
    },
    {
      ...
      location: "Phoenix, AZ",
      rating: 4,
      review: "Bought matching wedding bands for my wife and myself. The quality is excellent and they look stunning together. Shipping was fast and customer service was very helpful with sizing questions.",
      product: "Matching Wedding Bands Set",
      date: "2 weeks ago",
      verified: true
    },
    {
